...
`jg_detail_view_metadata_keys` TINYINT(1) NOT NULL DEFAULT 1,
`jg_detail_view_show_voting_btn` TINYINT(1) NOT NULL DEFAULT 1,
`jg_detail_view_show_download_btn` TINYINT(1) NOT NULL DEFAULT 1,
`jg_detail_view_show_comment_btn` TINYINT(1) NOT NULL DEFAULT 1,
`jg_detail_view_show_favorite_btn` TINYINT(1) NOT NULL DEFAULT 1,
`jg_detail_view_show_share_btn` TINYINT(1) NOT NULL DEFAULT 1,
